/**
 * @file view_functions.js (FITeduler)
 * 
...
define(function (require, exports, module) {
    module.exports = {
        ...
        /********** BINDS - bind functions from MODEL **********/
        bindModelFunction_changePageFrame: function(changePageFrame)
        {
            this.changePageFrame = changePageFrame;
        },

        bindModelFunction_loadTimetable: function(loadTimetable)
        {
            console.log("VIEW: binding model function loadTimetable()");
            this.loadTimetable = loadTimetable;
        },

        bindModelFunction_timetableAddLesson: function(timetableAddLesson)
        {
            this.timetableAddLesson = timetableAddLesson;
        },

        bindModelFunction_timetableClear: function(timetableClear)
        {
            this.timetableClear = timetableClear;
        },

        bindModelFunction_timetableGetItemAttribute: function(timetableGetItemAttribute)
        {
            this.timetableGetItemAttribute = timetableGetItemAttribute;
        },
        
        bindModelFunction_timetableChangeItemAttribute: function(timetableChangeItemAttribute)
        {
            this.timetableChangeItemAttribute = timetableChangeItemAttribute;
        },

        bindModelFunction_timetableGetItemAndLessonInfo: function(timetableGetItemAndLessonInfo)
        {
            this.timetableGetItemAndLessonInfo = timetableGetItemAndLessonInfo;
        },

        bindModelFunction_optionsLoadSubjects: function(optionsLoadSubjects)
        {
            this.optionsLoadSubjects = optionsLoadSubjects;
        },

        bindModelFunction_optionsCreateTimetable: function(optionsCreateTimetable)
        {
            this.optionsCreateTimetable = optionsCreateTimetable;
        },

        bindModelFunction_timetableClearTrash: function(timetableClearTrash)
        {
            this.timetableClearTrash = timetableClearTrash;
        },



        /********** VIEW FUNCTIONS **********/
        showPageFrame: function(frame)
        {
            $('.page_frame').hide();
            $('#frame_'+frame).show();
        ...
        renderTimetable: function(table, items)
        {
            var this_ = this;
        ...
        showLessonInfo: function(item, lesson)
        {
            $('.tab_panels').show();
        ...
        showSubjectsOptions: function(compulsory, optional)
        {
